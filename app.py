...
def make_scatter(df: pd.DataFrame) -> go.Figure:
    ...
    fig.update_layout(
        ...
        legend={"title": "Risk Status",
                ...
                "xanchor": "right",  "x": 1},
        xaxis={"gridcolor": "#ffffff18", "zerolinecolor": "#ffffff18"},
        yaxis={"gridcolor": "#ffffff18", "zerolinecolor": "#ffffff18"},
...
def make_feature_importance(importance_df: pd.DataFrame) -> go.Figure:
    ...
    fig = go.Figure(go.Bar(
        ...
        orientation="h",
        marker={"color": colors, "line": {"color": "#ffffff22", "width": 1}},
    ...
    fig.update_layout(
        ...
        paper_bgcolor="rgba(0,0,0,0)",
        font={"color": NEOM["text"]},
        xaxis={"gridcolor": "#ffffff18", "range": [0, 0.8],
               "tickformat": ".0%"},
...
def make_monthly_risk(df: pd.DataFrame) -> go.Figure:
    ...
    fig.update_layout(
        ...
        paper_bgcolor="rgba(0,0,0,0)",
        font={"color": NEOM["text"]},
        xaxis={"gridcolor": "#ffffff18"},
        yaxis={"gridcolor": "#ffffff18", "title": "Risk %"},
